...
// value of dropdown //
$('.select-saved-dropdown a').on('click', function(){
  $('.select-saved-btn').val($(this).text());
   if( $('.select-saved-btn').val($(this).text()) != "")
  {
    $('#deleteBtn').removeClass("d-none");
    $('#selectedMapping').addClass("d-none");
    $('#selectedMapMapping').addClass("d-none");
  }
});
...
$(function(){
  ...
  $(".dropdown-menu.dropdown-menuData1 a").click(function(){
    $(".btn.insertBtn2").text($(this).text());
  });
  $(".dropdown-menu.dropdown-menuData2 a").click(function(){
    $(".btn.insertBtn3").text($(this).text());
  })
});
